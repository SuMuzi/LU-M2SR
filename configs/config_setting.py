...
class setting_config:
    ...
    model_config = {
        ...
        'splict_nums':8,
        'res':True,
        'dic_atten': {'MSCB': False, 'CBAM': False},
    ...
    train_data_path = '/public/001/suqingguo/w2_common/data/DF2K/train_hdf5_3/'
    val_data_path = '/public/001/suqingguo/w2_common/data/DF2K/valid_hdf5_3/'
    test_data_path = '/public/001/suqingguo/w2_common/data/DF2K/valid_hdf5_3/'

    work_dir = '/public/001/suqingguo/w2_common/project_out/' + network + '/' + test_datasets + '/'+'x{}/'.format(scale) + datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'
    ck_dir = work_dir+'train/'+'checkpoint/'
    loss_dir = work_dir + 'train/' + 'loss_log/'
